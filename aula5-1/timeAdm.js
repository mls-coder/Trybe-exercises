document.getElementById('header-container').style.backgroundColor = '#22a28b';
document.getElementById('footer-container').style.backgroundColor = '#22a28b';
document.getElementsByClassName('emergency-tasks')[0].style.backgroundColor = '#ff99ff';
